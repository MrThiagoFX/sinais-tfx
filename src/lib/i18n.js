...
const DICT = {
  ...
  en: {
    ...
    "É uma ferramenta que detecta oportunidades operacionais (sinais) no MetaTrader com indicadores técnicos e te avisa em tempo real — atualmente em XAUUSD (ouro), nos tempos gráficos M15 e M30. São estudos operacionais de caráter informativo, não recomendação de investimento.": "It's a tool that detects trading opportunities (signals) in MetaTrader using technical indicators and alerts you in real time — currently on XAUUSD (gold), on the M15 and M30 timeframes. These are informational operational studies, not investment advice.",
  ...
  es: {
    ...
    "É uma ferramenta que detecta oportunidades operacionais (sinais) no MetaTrader com indicadores técnicos e te avisa em tempo real — atualmente em XAUUSD (ouro), nos tempos gráficos M15 e M30. São estudos operacionais de caráter informativo, não recomendação de investimento.": "Es una herramienta que detecta oportunidades operativas (señales) en MetaTrader con indicadores técnicos y te avisa en tiempo real — actualmente en XAUUSD (oro), en los marcos de tiempo M15 y M30. Son estudios operativos de carácter informativo, no recomendación de inversión.",
