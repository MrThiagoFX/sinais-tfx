...
const DICT = {
  ...
  en: {
    ...
    "Garantia da semana": "Week guarantee",
    "Se a semana fechar negativa, a próxima é por nossa conta — de graça.": "If the week closes negative, the next one is on us — free.",
    "Pagamento via Pix no atendimento. Liberação na hora após o pagamento.": "Payment via Pix in chat. Instant activation after payment.",
    "Começar grátis": "Start free",
    "Seu período grátis acabou": "Your free period has ended",
    "Os 15 dias grátis terminaram. Assine o Premium Semanal pra continuar recebendo os sinais.": "Your 15 free days are over. Subscribe to Weekly Premium to keep getting signals.",
    "Assinar pelo Telegram": "Subscribe via Telegram",
    ...
    "É uma ferramenta que detecta oportunidades operacionais (sinais) no MetaTrader com indicadores técnicos e te avisa em tempo real — para XAUUSD (ouro), US30 e BTCUSD (Bitcoin), nos tempos gráficos M5, M15 e M30. São estudos operacionais de caráter informativo, não recomendação de investimento.": "It's a tool that detects trading opportunities (signals) in MetaTrader using technical indicators and alerts you in real time — for XAUUSD (gold), US30 and BTCUSD (Bitcoin), on the M5, M15 and M30 timeframes. These are informational operational studies, not investment advice.",
    ...
    // Residual composto (nós com variáveis)
    "dia": "day", "dias": "days", "Usuário": "Username", "operações": "trades", "sinais": "signals", "de": "of",
    "Hoje": "Today", "3 meses": "3 months",
    "Poderá alterar de novo em": "You can change again in",
    "Seu plano atual é": "Your current plan is", ". Escolha para onde quer ir.": ". Choose where you want to go.",
    "primeiro sinal de domingo, a partir das": "Sunday's first signal, starting at",
    "Este sinal passou de": "This signal is older than", "min — você pode acompanhar, mas não entrar mais.": "min — you can follow it, but no longer enter.",
    "digite o cupom": "enter the coupon",
    "Pips acumulados em": "Pips accumulated over", "— laudo da ferramenta.": "— tool report.",
    "Janela atual:": "Current window:", ". Para alterar, acesse Perfil → Horário de sinais.": ". To change it, go to Profile → Signal schedule.",
    " Confirme o novo e-mail na caixa de entrada.": " Confirm the new email in your inbox.", " (e-mail não trocou: ": " (email not changed: ",
    "✓ Perfil salvo.": "✓ Profile saved.",
    "automático. Depois você muda pra \"sem limite\" no usuário. Vazio = desativa.": "automatic. Then change to \"no limit\" on the user. Empty = disables.",
  },
  ...
  es: {
    ...
    "Garantia da semana": "Garantía de la semana",
    "Se a semana fechar negativa, a próxima é por nossa conta — de graça.": "Si la semana cierra negativa, la próxima va por nuestra cuenta — gratis.",
    "Pagamento via Pix no atendimento. Liberação na hora após o pagamento.": "Pago vía Pix en la atención. Activación al instante tras el pago.",
    "Começar grátis": "Empezar gratis",
    "Seu período grátis acabou": "Tu período gratis terminó",
    "Os 15 dias grátis terminaram. Assine o Premium Semanal pra continuar recebendo os sinais.": "Tus 15 días gratis terminaron. Suscríbete al Premium Semanal para seguir recibiendo señales.",
    "Assinar pelo Telegram": "Suscribir por Telegram",
    ...
    "É uma ferramenta que detecta oportunidades operacionais (sinais) no MetaTrader com indicadores técnicos e te avisa em tempo real — para XAUUSD (ouro), US30 e BTCUSD (Bitcoin), nos tempos gráficos M5, M15 e M30. São estudos operacionais de caráter informativo, não recomendação de investimento.": "Es una herramienta que detecta oportunidades operativas (señales) en MetaTrader con indicadores técnicos y te avisa en tiempo real — para XAUUSD (oro), US30 y BTCUSD (Bitcoin), en los marcos de tiempo M5, M15 y M30. Son estudios operativos de carácter informativo, no recomendación de inversión.",
    ...
    "dia": "día", "dias": "días", "Usuário": "Usuario", "operações": "operaciones", "sinais": "señales", "de": "de",
    "Hoje": "Hoy", "3 meses": "3 meses",
    "Poderá alterar de novo em": "Podrás cambiar de nuevo en",
    "Seu plano atual é": "Tu plan actual es", ". Escolha para onde quer ir.": ". Elige a dónde quieres ir.",
    "primeiro sinal de domingo, a partir das": "la primera señal del domingo, a partir de las",
    "Este sinal passou de": "Esta señal pasó de", "min — você pode acompanhar, mas não entrar mais.": "min — puedes seguirla, pero ya no entrar.",
    "digite o cupom": "escribe el cupón",
    "Pips acumulados em": "Pips acumulados en", "— laudo da ferramenta.": "— informe de la herramienta.",
    "Janela atual:": "Ventana actual:", ". Para alterar, acesse Perfil → Horário de sinais.": ". Para cambiar, ve a Perfil → Horario de señales.",
    " Confirme o novo e-mail na caixa de entrada.": " Confirma el nuevo correo en tu bandeja.", " (e-mail não trocou: ": " (correo no cambió: ",
    "✓ Perfil salvo.": "✓ Perfil guardado.",
    "automático. Depois você muda pra \"sem limite\" no usuário. Vazio = desativa.": "automático. Luego cámbialo a \"sin límite\" en el usuario. Vacío = desactiva.",
  },
};
